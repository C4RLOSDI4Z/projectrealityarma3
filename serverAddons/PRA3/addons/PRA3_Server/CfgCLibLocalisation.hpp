    ...
    class PRA3 {
        ...
        class Common {
            class SpawnsRemaining {
                ...
                Korean = "%1 (스폰 %2 남음)";
                Spanish = "%1 (%2 entradas restantes)";
            };
        };
        ...
        class Squad {
            class waitToSwitchSide {
                ...
                Spanish = "Debes esperar %1 segundos para cambiar de bando de nuevo";
            };
            class MaxPlayerCount {
                ...
                Spanish = "Número máximo de jugadores enemigos alcanzado.";
            };
        };
        ...
        class RespawnUI {
            class JoinASquad {
                ...
                Korean = "분대에 참여해주십시오";
                Spanish = "Tienes que unirte a un escuadrón!";
            };
            class ChooseARole {
                ...
                Korean = "보직을 선택해주십시오";
                Spanish = "Tienes que seleccionar un rol!";
            };
            class selectSpawn {
                ...
                Spanish = "Tienes que seleccionar un punto de entrada!";
            };
        };
        ...
        class Logistic {
            ...
            class noCargoSpace {
                ...
                Spanish = "No hay espacio de carga disponible";
            };
            class UnloadItem {
            ...
            class itemToHeavy {
                ...
                Spanish = "El artículo se excede por %1Kg en peso";
            };
        };
        ...
        class Rally {
            ...
            class cantPlaceRally {
                ...
                Spanish = "No puedes colocar una Meta en esta ubicación";
            };
            class RallyPlaced {
                ...
                Spanish = "Tu Líder de Escuadrón ha colocado una meta cerca de %1";
            };
        };
        ...
        class Kit {
            class NotAllowToDrive {
                ...
                Spanish = "No tienes permitido utilizar este vehiculo";
            };
        };
    };
};
